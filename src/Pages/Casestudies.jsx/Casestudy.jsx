...
const nextcasestudies = [
    {
      heading: "Codibot AI Chatbot for Mutual Fund Customers in a Commercial Bank",
    ...
    {
      heading: "Enhancing Blended Learning for Students at Springfield High School",
...
function Casestudy() {
    ...
    return (
      <div>
        <section className="overflow-x-hidden text-lg max-xl:text-base">
          <section id="overview" className="mt-20 max-lg:mt-16 pb-5">
            <div className="xl:px-32 px-16 max-lg:px-4">
              <div className="lg:flex items-start gap-16 max-xl:gap-10">
                ...
                <div>
                  <p>Use Case — </p>
                  <p className="text-4xl my-5 max-lg:text-2xl">
                    {data?.topheading}
                  </p>
                  <p className="">
                    {" "}
              ...
              <div className="mt-14 flex justify-center items-center">
                <img src={data?.img} className="max-lg:h-[11rem] w-[80rem] object-cover" alt="" />
              </div>
            </div>
          </section>

          <section className="xl:px-32 px-16 max-lg:px-4 mt-12 lg:flex gap-16">
            <div>
              <div>
                {data?.role && (
                  <p className="">
              ...
              <p className="font-bold mt-8">{data?.headingafterrole}</p>
              {data?.headingwithoutsub.map((n) => (
                <div className="mt-8">
                ...
                <div className="mt-8">
                  ...
                  {n.subheadings.map((n) => (
                    <div className="flex items-start gap-4 lg:ml-[7%] mb-3">
                      ...
                      <p>
                        {" "}
                        <span className="font-bold">{n.subheading}</span>{" "}
                        {n.text}
                      </p>
                    </div>
                  ))}
            ...
            <div className="">
              <p className="mb-10 font-semibold">Use Case — </p>
              {nextcasestudies.map((n) => (
                ...
                >
                  <p className="h-12 xl:h-14 text-ellipsis">{n.heading}</p>
                  <img
                    src={n.img}
