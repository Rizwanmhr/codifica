...
// import { casestudy2 } from "./casestudies";
...
function CaseStudyTravelAssistant() {
      ...
      <section className="overflow-x-hidden text-lg max-xl:text-base  max-w-[67.5rem] m-auto">
        <section id="overview" className="mt-20 max-lg:mt-16 pb-5">
          <div className="max-lg:px-4">
            <div className="lg:flex items-start gap-[7.8rem] max-xl:gap-10">
              ...
              <div>
                ...
                <p className="text-[2.5rem] my-5 max-lg:text-2xl leading-[3.5rem]">
                  {casestudy2?.topheading}
                </p>
                <p className="text-xl text-[#3A3A3A]">
                  {" "}
                  <span className="font-bold">Background:</span>{" "}
                  {casestudy2?.background}
                </p>
              </div>
            </div>
            <div className="mt-14 flex justify-center items-center">
              <img src={casestudy2?.img} className="max-lg:h-[11rem]" alt="" />
            </div>
          </div>
        </section>
        ...
        <section className="max-lg:px-4 mt-12 lg:flex gap-[7.8rem]">
          <div>
            ...
            <p className="font-bold text-xl mt-8">
              {casestudy2?.headingafterrole}
            </p>
            {casestudy2?.headingwithoutsub.map((n) => (
            ...
            {casestudy2?.datawithsubheading.map((n) => (
...
export default CaseStudyTravelAssistant;
