          ...
          <div className="max-lg:px-4">
            <div className="lg:flex items-start gap-16 max-xl:gap-10">
              ...
              <div>
                ...
                <p className="text-[2.5rem] text-4xl my-5 max-lg:text-2xl leading-[3.5rem]">
                  {casestudy3?.topheading}
                </p>
                <p className="text-xl text-[#3A3A3A]">
                  {" "}
                  <span className="font-bold">Background:</span>{" "}
                  {casestudy3?.background}
                </p>
              </div>
            </div>
            <div className="mt-14 flex justify-center items-center">
              <img src={casestudy3?.img} className="max-lg:h-[11rem]" alt="" />
            </div>
          </div>
        </section>
        ...
        <section className="max-lg:px-4 mt-12 lg:flex gap-16">
          <div>
            ...
            <p className="font-bold text-xl mt-8">
              {casestudy3?.headingafterrole}
            </p>
            {casestudy3?.headingwithoutsub.map((n) => (
            ...
            {casestudy3?.datawithsubheading.map((n) => (
